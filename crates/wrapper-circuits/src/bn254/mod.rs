...
pub use metrics::{
  ...
  fp12_cyclotomic_square_layout_metrics, fp12_mul_k, fp12_mul_layout_metrics, fp12_square_k,
  ...
  miller_loop_layout_metrics, pairing_check_k, pairing_check_layout_metrics,
};
