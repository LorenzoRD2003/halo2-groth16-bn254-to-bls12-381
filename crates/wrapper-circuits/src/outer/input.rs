...
use crate::{Groth16Bn254Proof, Groth16Bn254VerifyingKey, NativeField};

use super::{OuterStatementInput, OuterStatementSemantics};
...
pub struct OuterWrapperCircuitInput {
  ...
  pub inner_public_inputs: Vec<NativeField>,
...
impl OuterWrapperCircuitInput {
  ...
  pub fn without_witnesses(&self) -> Self {
    Self {
      ...
      inner_public_inputs: vec![NativeField::ZERO; self.inner_public_inputs.len()],
